...
export const productData: ProductDataTypes[] = [
...

  {
    ...
    rating: 4.2,
    stockCount: 8,
    colors: ['#212529', '#f4a100'],
    sizes: ['SM', 'MD', 'LG', 'XL'],
    description: 'A sophisticated suit designed with a modern fit and premium finish.',
  },

  {
    id: '3',
    image: '/assets/cloth-2.webp',
    name: 'Checkered Slim Collar Shirt',
    price: 94,
    oldPrice: 120,
    discount: 22,
    rating: 4.6,
    ...
    description: 'A stylish checkered shirt with a slim collar and comfortable everyday fit.',
  },

  {
    ...
    sizes: ['XS', 'SM', 'MD', 'LG'],
    description: 'Lightweight athletic leggings designed for comfort and everyday movement.',
  },

  {
    ...
    sizes: ['SM', 'MD', 'LG', 'XL'],
    description: 'Classic denim overalls shorts with a relaxed fit and timeless styling.',
  },

  {
    ...
    rating: 4.7,
    stockCount: 5,
    colors: ['#212529', '#8B7355'],
    sizes: ['SM', 'MD', 'LG', 'XL', 'XXL'],
    description: 'A warm plaid wool coat designed for a refined winter look.',
  },

  {
    ...
    description: 'Comfortable jogger pants made for relaxed everyday wear.',
  },

  {
    ...
    colors: ['#000000', '#36454F'],
    sizes: ['SM', 'MD', 'LG', 'XL'],
    description: 'A lightweight water-resistant jacket designed for outdoor comfort.',
  },
];
      ...
      <Nav.Item as="li" className="nav-item">
        <Nav.Link eventKey={'List'}>
          <svg
            ...
            dangerouslySetInnerHTML={{ __html: SVGICON.ListSvg }}></svg>
        </Nav.Link>
      </Nav.Item>
      <Nav.Item as="li" role="presentation">
        <Nav.Link eventKey={'Coloumn'}>
          <svg
            ...
            width="512"
            height="512"
            dangerouslySetInnerHTML={{ __html: SVGICON.ColoumnSvg }}></svg>
        </Nav.Link>
      </Nav.Item>
      <Nav.Item as="li" role="presentation">
        <Nav.Link eventKey={'Grid'}>
          <svg
            ...
            width="512"
            height="512"
            dangerouslySetInnerHTML={{ __html: SVGICON.GridSvg }}></svg>
        </Nav.Link>
      </Nav.Item>
    </Nav>
  );
