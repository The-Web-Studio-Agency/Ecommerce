...
export default function ShopStandard() {
  ...
  return (
    <div className="page-content ">
      <CommonBanner2 parentText="Home" currentText="Shop Standard" mainText="Shop Standard"></CommonBanner2>
      {/* <CommanBanner parentText="Home" currentText="Shop Standard" mainText="Shop Standard" image={IMAGES.BackBg1.src} /> */}
      <h1 className="product-page-title">ALL PRODUCT</h1>
      ...
      <Modal className="quick-view-modal" centered show={detailModal} onHide={() => setDetailModal(false)}>
