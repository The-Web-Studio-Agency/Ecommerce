                        ...
                        <div className="row justify-content-center">
                            <div className="col-xl-8 col-lg-8">
                                <div className="dz-blog blog-single style-1 sidebar"> 
                                    ...
                                    <div className="dz-media post-audio">
                                        <iframe className="rounded" src="https://www.youtube.com/embed/pyRjzvdOSHk" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                                    </div>
