                            ...
                            <div className="col-xl-8 col-lg-8">
                                <div className="dz-blog blog-single style-1 sidebar"> 
                                    ...
                                    <div className="dz-media rounded">
                                        <Image src={IMAGES.BlogDetailPic1} alt="profile" className="w-100" />
                                        <div className="quote-text">
                                            <blockquote className="wp-block-quote">
                                                <p>Etiam scelerisque tellus eget enim porta, nec lobortis turpis ullamcorper. Morbi faucus egestas sem, a dictum nibh tincidunt sit amet.</p>
                                                <cite className="quote-word">
                                                    Daniels Fulton
                                                </cite>
                                            </blockquote>
                                        </div>
